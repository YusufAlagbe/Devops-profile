...
export default function Contact() {
  ...
  const contactItems = [
    { Icon: MdEmail, label: "Email", value: "Alagbeyusuf21@gmail.com", href: "mailto:Alagbeyusuf21@gmail.com", color: "#00d4b8" },
    { Icon: MdPhone, label: "Phone", value: "+1 (602) 829-0385", href: "tel:+16028290385", color: "#f59e0b" },
    { Icon: MdLocationOn, label: "Location", value: "Plano, TX (Open to Remote)", color: "#8b5cf6" },
  ]

  const socialLinks = [
    { Icon: FaLinkedin, name: "LinkedIn", handle: "/in/yusuf-alagbe-olatunji", href: "https://www.linkedin.com/in/yusuf-alagbe-olatunji", color: "#0077b5" },
    { Icon: FaGithub, name: "GitHub", handle: "YusufAlagbe", href: "https://github.com/YusufAlagbe", color: "#6e40c9" },
    { Icon: FaDocker, name: "Docker Hub", handle: "yoalagbe1", href: "https://hub.docker.com/u/yoalagbe1", color: "#2496ed" },
  ]
              ...
              <div style={{ display: "grid", gap: 20, marginBottom: 40 }}>
                {contactItems.map(c => (
                  <div key={c.label} style={{ display: "flex", gap: 14, alignItems: "center" }}>
                    <div style={{ width: 44, height: 44, background: `${c.color}18`, border: `1px solid ${c.color}40`, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                {socialLinks.map(s => (
                  <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer"
                    ...
                    <div style={{ width: 36, height: 36, background: `${s.color}18`, borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div>
              {sent ? (
                <div className="card" style={{ padding: 40, textAlign: "center" }}>
                  ...
                  <p style={{ color: "var(--text-dim)" }}>Your email client should have opened. I will get back to you within 24 hours.</p>
