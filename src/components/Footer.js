  ...
  return (
    <footer style={{ background: 'var(--bg2)', borderTop: '1px solid var(--border)', padding: '48px 0 32px' }}>
      <div className="container-custom">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 32, marginBottom: 40 }} className="footer-grid">
          <div>
          ...
          <div>
            ...
            <div style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginBottom: 8, wordBreak: 'break-word' }}>Alagbeyusuf21@gmail.com</div>
            <div style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginBottom: 8 }}>+1 (602) 829-0385</div>
            <div style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginBottom: 16 }}>Plano, TX</div>
            <div style={{ display: 'flex', gap: 10 }}>
              {[{ href: 'https://www.linkedin.com/in/yusuf-alagbe-olatunji', label: 'in' }, { href: 'https://github.com/YusufAlagbe', label: 'gh' }].map(s => (
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
          <span style={{ color: 'var(--text-muted)', fontSize: '0.78rem', fontFamily: 'JetBrains Mono, monospace' }}>© {new Date().getFullYear()} Yusuf Alagbe. All rights reserved.</span>
          <span style={{ color: 'var(--text-muted)', fontSize: '0.78rem' }}>Built with Next.js · Deployed on Vercel</span>
        </div>
      </div>
    </footer>
  )
