      ...
      <section style={{ padding: '80px 0' }}>
        <div className="container-custom">
          ...
          <h2 className="section-title" style={{ marginBottom: 24 }}>
            Building Infra That <span style={{ color: 'var(--teal)' }}>Never Sleeps</span>
          </h2>
          <p style={{ color: 'var(--text-dim)', marginBottom: 20, lineHeight: 1.8, maxWidth: 720 }}>
            Based in Plano, TX, I am a Senior DevOps Engineer who bridges the gap between development velocity and operational reliability.
          </p>
          <p style={{ color: 'var(--text-dim)', marginBottom: 36, lineHeight: 1.8, maxWidth: 720 }}>
